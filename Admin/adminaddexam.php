...
<body>
    ...
    <section class="section">
        <div class="sidenav" id="sidebar">
            ...
            <a href="adminaddexam.php" class="active">Add Exam</a>
        ...
        ?>
            <div class="container-fluid submain">
                ...
                <p style="color: white; background-color: chocolate; font-weight: bold; text-align: center; font-size: 24px;">ADD EXAM</p>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-floating mb-2 mt-2">
                                <input class="form-control" type="number" placeholder="Enter Maximum Marks" id="maxmarks" name="maxmarks">
                                <label for="examname">Enter Maximun Marks</label>
                            </div>
                        </div>
                    </div>
                    <div class="row">

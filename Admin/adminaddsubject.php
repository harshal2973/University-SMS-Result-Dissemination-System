...
<body>
    ...
    <section class="section">
        <div class="sidenav" id="sidebar">
            ...
            <a href="adminaddsubject.php" class="active">Add Subject</a>
        ...
        ?>
            <div class="container-fluid submain">
                ...
                <p style="color: white; background-color: chocolate; font-weight: bold; text-align: center; font-size: 24px;">ADD SUBJECT</p>
                <div class="container addcourseform">
                <form method="post" action="onaddsubject.php">
                <div class="row">
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-floating mb-2 mt-2">
                                <input type="text" class="form-control" id="subjectid" placeholder="Enter Subject Id" name="subjectid">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-floating mb-2 mt-2">
                                <input type="text" class="form-control" id="subjectabbr" placeholder="Enter Subject Abbr" name="subjectabbr">
                                <label for="subjectabbr">Subject Abbreviation</label>
                            </div>
                        </div>
                    </div>
                    <div class="row">

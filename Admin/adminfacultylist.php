    ...
    <section class="section">
        ...
        <div class="main" id="sidemain">
            <div class="container-fluid" style=" border:1px solid chocolate; width: 77%; margin-top: 30px; margin-left: 280px; padding: 0px; float:left;">
                    <p style="color: white; background-color: chocolate; font-weight: bold; text-align: center; font-size: 24px;">FACULTY LIST</p>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                                ...
                                $sql="select fname,lname,gen,email,mno,uname,sem from faculty_table";
